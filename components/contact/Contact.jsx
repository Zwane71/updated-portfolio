...
const Contact = () => {
  ...
  return (
    <div
      id='contact' className=' w-full px-[12%] py-10 scroll-m-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] '>
      ...
      <form className='max-w-2xl mx-auto' onSubmit={onSubmit}>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            <input type="email" placeholder='Enter Your Emal' required name='email' className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white' />
